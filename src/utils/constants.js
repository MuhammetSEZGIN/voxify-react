...
export const CALL_RINGTONE_SOUND = '/Save_Point_Morning.mp3';
export const VOICE_JOIN_NOTIFICATION_SOUND = '/girissesi.mov';
export const VOICE_LEAVE_NOTIFICATION_SOUND = '/cikissesi.mov';
