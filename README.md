...
- **Voice / Audio:** LiveKit Components
- **Styling:** CSS / HTML (Tailor-made for performance)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/MuhammetSEZGIN/sesver-react.git
   cd sesver-react/discord-app-js
